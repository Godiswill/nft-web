...
const paths = [
    ...
    { path: 'https://discord.com', name: 'discord', components: <DiscordIcon /> },
    { path: 'https://twitter.com', name: 'twitter', components: <TwitterIcon /> },
    { path: 'https://instagram.com', name: 'instagram', components: <VectorIcon /> },
    { path: 'https://youtube.com', name: 'youtube', components: <YoutubeIcon /> },
];
