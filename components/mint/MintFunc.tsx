...
function MintFunc() {
    ...
    const { PRICE, MAX, SUPPLY, mintedCnt, cost, isWErr, wErr, write } = useFreeMint(cnt);
    ...
    return (
        <>
            ...
            {address && (
                <div className="flex justify-center my-9">
                    <button
                        className="h-10 flex justify-center items-center px-4 bg-[#D7C19A] text-black rounded font-bold shadow-[0px_4px_12px_rgba(0, 0, 0, 0.1)] transition hover:scale-[1.025]"
                        onClick={() => write?.()}
                    >
                        Mint
                    </button>
